  ...
  return (
    <div>
      ...
      <div
        ...
        onDragOver={(e) => {
          e.preventDefault();
          if (!fieldsDisabled && canAddMore) setDragOver(true);
        }}
      ...
      >
        <input
          ...
          disabled={fieldsDisabled || !canAddMore}
        ...
        {filesWithPreviews.length > 0 ? (
          ...
          <div className="space-y-3">
            <svg className={`w-16 h-16 mx-auto ${isDark ? 'text-gray-500' : 'text-gray-400'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
