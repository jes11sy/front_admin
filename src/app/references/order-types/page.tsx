    ...
    <div>
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <h1 className={`text-xl font-semibold ${isDark ? 'text-gray-100' : 'text-gray-800'}`}>Типы заказов</h1>
        </div>
      ...
      {showAdd && (
        <div className={`mb-6 p-4 rounded-xl border ${isDark ? 'bg-[#2a3441] border-teal-700/40' : 'bg-teal-50 border-teal-200'}`}>
          ...
          <div className="flex gap-3 items-end flex-wrap">
            <input className={`${inputCls} max-w-xs`} placeholder="Название" value={form.name} onChange={e => setForm({...form, name: e.target.value})} />
